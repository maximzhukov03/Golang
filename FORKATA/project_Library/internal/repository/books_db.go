...
func (d *BooksRepositoryPostgres) GetByID(ctx context.Context, id int) (models.Book, error){
...
func (d *BooksRepositoryPostgres) Delete(ctx context.Context, id int) error{
